...
def scraper
  ...
  while page <= last_page
    pagination_url = "https://www.blockwork.cc/listings?page=#{page}"
    puts pagination_url
    puts "Page: #{page}"
    puts ''
    ...
    pagination_job_listings.each do |job_listing|
      job = {
        ...
        url: "https://www.blockwork.cc/" + job_listing.css('a')[0].attributes["href"].value
      }
      jobs << job
